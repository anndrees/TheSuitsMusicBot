  ...
  async play(song, message, client, filters) {
    ...
    if (!song) {
      ...
      const endembed = new MessageEmbed().setColor("#F0EAD6")
        .setAuthor(`Lista Finalizada.`, "https://i.redd.it/y3wduhwn4gd61.jpg")
    ...
    try {
      let embed = new MessageEmbed()
        ...
        .setDescription(`Cancion: [\`${song.title}\`](${song.url})`)
        .addField("`🩸 Pedida por:", `>>> ${message.author.tag}`, true)
      ...
      switch (reaction.emoji.name) {
        ...
        case "⏯":
          ...
          if (queue.playing) {
            ...
            queue.textChannel.send(`${user} ▶ reanudo la musica!`).catch(console.error);
          }
          break;
        ...
        case "🔇":
          ...
          if (queue.volume <= 0) {
            ...
            queue.textChannel.send(`${user} 🔊 desmuteo la musica!`).catch(console.error);
          } else {
            queue.volume = 0;
            queue.connection.dispatcher.setVolumeLogarithmic(0);
            queue.textChannel.send(`${user} 🔇 muteo la musica!`).catch(console.error);
          }
          break;
        ...
        case "🔉":
          ...
          queue.textChannel
            .send(`${user} 🔉 bajo el volumen, el volumen ahora es ${queue.volume}%`)
            .catch(console.error);
          break;
        ...
        case "🔊":
          ...
          queue.connection.dispatcher.setVolumeLogarithmic(queue.volume / 100);
          queue.textChannel
            .send(`${user} 🔊 subio el volumen, el volumen ahora es ${queue.volume}%`)
            .catch(console.error);
          break;
        ...
        case "🔁":
          ...
          queue.textChannel.send(`El bucle esta ${queue.loop ? "**activado**" : "**desactivado**"}`).catch(console.error);
          break;
        ...
        case "🔀":
          ...
          queue.textChannel
            .send(`${user} 🔀 cambio el orden de la lista.`)
            .catch(console.error);
          break;
        ...
        case "🎵":
          ...
          let nowPlaying = new MessageEmbed()
            .setAuthor('♪Sonando ahora♪', 'https://i.redd.it/y3wduhwn4gd61.jpg', 'http://harmonymusic.tk')
        ...
        case "📑":
          ...
          let temEmbed = new MessageEmbed()
            .setAuthor("Buscando...", "https://i.redd.it/y3wduhwn4gd61.jpg").setFooter("Lyrics")
            .setColor("#F0EAD6")
