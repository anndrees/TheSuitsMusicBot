...
module.exports = {
  ...
  cooldown: 5,
  edesc: `Escribe este comando para pausar la cancion!\nModo de uso: ${PREFIX}pause`,
  execute(message) {
    ...
    if (queue.playing) {
      ...
      .setAuthor(`${message.author.username} pauso la musica.`, "https://i.redd.it/y3wduhwn4gd61.jpg")
